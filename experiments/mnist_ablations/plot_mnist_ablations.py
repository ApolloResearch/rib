"""Plot the results of mnist_ablations experiments.
...
Usage:
    python plot_mnist_ablations.py <path/to/results_json_file1> <path/to/results_json_file2> ...

    The results_json_files should be outputs of the run_mnist_ablations.py script.
"""
import json
